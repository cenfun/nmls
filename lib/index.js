...
class NMLS {
    ...
    async initDependencies() {
        ...
        if (this.moduleInfo.isRoot) {
            ...
            this.moduleInfo.dependenciesInfo = await this.generateDependencies(this.moduleInfo, "dependencies", info);
        }
    ...
    generateSubDependencies(totalInfo, currentModule) {
        ...
        for (var subName in dependencies) {
            ...
            if (!subModule) {
                var list = [currentModule.path];
                var m = currentModule.parent;
                while (m) {
                    if (m.path === this.root) {
                        break;
                    }
