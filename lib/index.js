...
class NMLS {
    ...
    async readNodeModules() {
        ...
        var devDependencies = this.packageJson.devDependencies;
        ...
        this.projectInfo.dependenciesInfo = await this.generateDependencies("dependencies");
        this.projectInfo.devDependenciesInfo = await this.generateDependencies("devDependencies");
    ...
    async generateDependencies(key) {
        ...
        var dependencies = this.projectInfo[key];
        if (!dependencies) {
            return dInfo;
        }
    ...
    getDependenciesInfo(key) {
        ...
        var dependenciesInfo = this.projectInfo[key + "Info"];
