...
class NMLS {
    ...
    async start(option = {}) {
        ...
        await this.showInfo(projectInfo);
    ...
    async showInfo(projectInfo) {
        ...
        if (this.moduleList.length) {
            ...
            this.moduleList.forEach(m => {
                ...
                if (mInfo) {
                    ...
                    Util.initDependenciesInfo(sub, mInfo.dMap, true);
                    if (sub.dMap) {
                        mInfo.subs = [sub];
                    }
                    subs.push(mInfo);
        ...
        await this.showGrid(projectInfo);
